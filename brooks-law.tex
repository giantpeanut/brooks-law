...
\section*{Case I: extends Base}
    \begin{atomize}
        ...
        \item Interpret:
            \begin{itemize}
								\item In the case where $s=0$, new employees never become senior
								engineers and hence never contribute anything to the project.
								This is essentially the same as not hiring anybody. So we have
								$p_{i}=ky_{0}t + p_{0}$
